  ...
  return (
    <>
      <nav className='nav'>
        <div className="logo">
          <Link to='/'>
            <img style={{maxWidth:"35px"}} src="https://cdn.pixabay.com/photo/2014/04/02/10/53/shopping-cart-304843_960_720.png" alt="logo"/>
            <span >E-com</span>
          </Link>
        </div>
        <div className="nav-items">
          <ul className="nav-items">
            ...
            {authToken && <li className="nav-links">
              <Tooltip title='Cart'>
                <NavLink to="/cart">
                  <span className='nav-icon-span'>Cart    <Badge badgeContent={setProceed ? cart.products?.length : 0}> <AiOutlineShoppingCart className='nav-icon' /></Badge></span>
                </NavLink>
              </Tooltip>
            </li>}
            {authToken && <li className="nav-links">
